...
public class SRSCPEC extends SRSGeneral {
    ...
    public ArrayList<SRSGraph> cpecClothoWrapper(ArrayList<Part> goalParts, HashSet<Vector> vectors, HashSet<String> required, HashSet<String> recommended, HashSet<String> forbidden, ArrayList<Part> partLibrary, boolean modular, HashMap<Integer, Double> efficiencies) {
        try {
