...
public class SRSGibson extends SRSGeneral {
    ...
    public ArrayList<SRSGraph> gibsonClothoWrapper(ArrayList<Part> goalParts, HashSet<Vector> vectors, HashSet<String> required, HashSet<String> recommended, HashSet<String> forbidden, ArrayList<Part> partLibrary, boolean modular, HashMap<Integer, Double> efficiencies) {
        try {
            ...
            HashSet<SRSVector> vectorSet = vectorImportClotho(vectors);
...
//            E.printStackTrace();
    ...
    private ArrayList<SRSGraph> assignVector (ArrayList<SRSGraph> optimalGraphs, HashSet<SRSVector> vectorSet) {
