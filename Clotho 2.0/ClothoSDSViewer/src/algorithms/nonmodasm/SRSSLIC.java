...
public class SRSSLIC extends SRSGeneral{
    ...
    public ArrayList<SRSGraph> slicClothoWrapper(ArrayList<Part> goalParts, HashSet<Vector> vectors, HashSet<String> required, HashSet<String> recommended, HashSet<String> forbidden, ArrayList<Part> partLibrary, boolean modular, HashMap<Integer, Double> efficiencies) {
        try {
