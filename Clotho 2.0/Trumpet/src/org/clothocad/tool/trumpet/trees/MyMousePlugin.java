 ...
 * @author Craig
 */
public class MyMousePlugin<V,E> extends AbstractPopupGraphMousePlugin {


    protected Factory<V> vertexFactory;
    protected Factory<E> edgeFactory;
    protected JPopupMenu popup = new JPopupMenu();
    public V parentVertex;
    public final TrumpetGUI gui;

    public MyMousePlugin(TrumpetGUI gui) {
...
//                }
                popup.removeAll();
                popup.add(new AbstractAction("Create Constrcut") {
                    public void actionPerformed(ActionEvent e) {
                        pickedVertexState.pick(vertex, false);
                          parentVertex = vertex;
                          gui.generateResults(parentVertex.toString());
                        vv.repaint();
                    }});
