...
public class eugeneFrame extends JFrame {
    ...
    public void initComponents() {
        ...
        makeHeaderButton = new JButton("Make Header Files");
        makeHeaderButton.addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent e) {
                if (tabbedPane.getTabCount() != 0) {
                    eugeneProcess.generateHeaderFiles(bottomPane());
                    eugeneProcess.generatePartList(bottomPane());
                }
            }
        });
        ...
        clearOutputButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JTextPane bottomPane = bottomPane();
                if (bottomPane != null) {
                    bottomPane.setText("");
                }
            }
        ...
        buttonBar.add(makeHeaderButton);
    ...
    private JTextPane bottomPane() {
        JSplitPane splitPane = splitPane();
        JTextPane bottomPane = null;
        if (splitPane != null) {
            JScrollPane scroll = (JScrollPane) splitPane.getBottomComponent();
            bottomPane = (JTextPane) scroll.getViewport().getComponent(0);
        }
        return bottomPane;
    }
    ...
    private JSplitPane createSplitPane() {
        ...
        MessageConsole mc = new MessageConsole(bottomPane);
